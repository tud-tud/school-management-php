...
if (isset($_SESSION['admin_id']) && isset($_SESSION['role'])) {
    if ($_SESSION['role'] == '1') {
        ...
        if (
            ...
            $data = 'uname=' . $uname . '&fname=' . $fname . '&lname=' . $lname . '&address=' . $address . '&email=' . $email_address . '&pfn=' . $parent_fname . '&pln=' . $parent_lname . '&pph=' . $parent_phone_number;
            ...
            if (empty($fname)) {
                ...
                $sql = "INSERT INTO students(username, password,fname,lname,grade,section,address,gender,email_address,date_of_birth,parent_fname,parent_lname,parent_phone_number) VALUES(?,?,?,?,?,?,?,?,?,?,?,?,?)";
